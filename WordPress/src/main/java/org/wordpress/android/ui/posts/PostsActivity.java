...
public class PostsActivity extends WPDrawerActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            mCategoryName = CaredearUtils.getCategoryNameById(extras.getInt(PostsActivity.EXTRA_CATEGORY_ID));
...
//        }
    ...
    public void requestPosts() {
        ...
        // Caredear, Cheng, 2015-Jan-10, 不要每次进入就自动刷新
    ...
    public void showTitlePanel(boolean show) {
        if (mTitlePanel != null) {
            mTitlePanel.setVisibility(show ? View.VISIBLE : View.GONE);
        }
    }
