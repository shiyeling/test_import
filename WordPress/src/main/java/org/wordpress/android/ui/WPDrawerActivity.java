...
import org.wordpress.android.ui.caredear.CdSignInActivity;
...
public abstract class WPDrawerActivity extends ActionBarActivity {
    ...
    private void initMenuDrawer() {
        ...
        if (mDrawerLayout != null) {
            ...
            // ##DEBUG## Caredear, Cheng, 2015-Jan-14, Bug 4912, 隐藏左边的操作面板
            drawerWidth = 0;
            // End, Bug 4912
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        // Caredear, Cheng, 不让用户打开左侧面板访问媒体、页面、评论、统计、设置等等
