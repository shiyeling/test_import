...
public class ViewPostFragment extends Fragment {
    ...
    public void onResume() {
        ...
        parentActivity.showTitlePanel(false);
        LocalBroadcastManager.getInstance(getActivity().getApplicationContext()).registerReceiver(
                mReceiver, new IntentFilter(SuggestionService.ACTION_SUGGESTIONS_LIST_UPDATED));
    }
    ...
    public void onPause() {
        ...
        parentActivity.showTitlePanel(true);
    }
    ...
    private class InsertViewHistoryTask extends AsyncTask<Void, Void, Boolean> {
        private long localDBPostId;
        public InsertViewHistoryTask(long localDBPostId){
            this.localDBPostId = localDBPostId;
        }

        @Override
        protected Boolean doInBackground(Void... nada) {
            WordPress.wpDB.insertPostViewHistory(this.localDBPostId);
            return true;
        }
    }
    ...
    public void loadPost(final Post post) {
        ...
        new InsertViewHistoryTask(post.getLocalTablePostId()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
