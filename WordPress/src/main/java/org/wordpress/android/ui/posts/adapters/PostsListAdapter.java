...
public class PostsListAdapter extends BaseAdapter {
    ...
    public PostsListAdapter(Context context, boolean isPage, int category,
                            OnLoadMoreListener onLoadMoreListener,
                            OnPostsLoadedListener onPostsLoadedListener) {
        mContext = context;
        mIsPage = isPage;
        mCategory = category;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(post.isRead()){
            wrapper.getTitle().setTextColor(mContext.getResources().getColor(R.color.gray));
        }else{
            wrapper.getTitle().setTextColor(mContext.getResources().getColor(R.color.black));
        }
    ...
    private class LoadPostsTask extends AsyncTask <Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... nada) {
            ...
            loadedPosts = WordPress.wpDB.getPostsListPostsForCategory(
                    WordPress.getCurrentLocalTableBlogId(), mIsPage, mCategory);
